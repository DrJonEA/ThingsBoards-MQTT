...
#define MQTT_CONNECT_TIMEOUT 500
#endif

// Enumerator used to control the state machine at centre of agent
enum MQTTState {  Offline, TCPReq, TCPConned,  MQTTRecon, Online};
...
private:
	...
	void connectCmdHandler( MQTTAgentCommandContext_t * pCmdCallbackContext,
	            MQTTAgentReturnInfo_t * pReturnInfo );
	...
	MQTTAgentConnectArgs xAgentConnectArgs;
	MQTTAgentCommandContext_t xAgentCommandContext;
